...
EXPORT void outsol  (FILE *fp, const sol_t *sol, const double *rb,
                     const solopt_t *opt);
/*slynen{*/
EXPORT void outros(double* pos, double* rr, double* enu, double* P, double* Q, const sol_t *sol, const double *rb,
    const solopt_t *opt);
EXPORT int repstr(char *str, const char *pat, const char *rep);
 /*}*/
